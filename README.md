...
- 🗄️ **SQLite Database**: Default local database setup
...
### 🛡️ Admin Authenticated Routes (Protected)
...
- ✏️ `GET /admin/experiences/{id}/edit` - Edit experience
- 🔄 `PUT /admin/experiences/{id}` - Update experience
- 🗑️ `DELETE /admin/experiences/{id}` - Delete experience
